...
interface MusicService {
    ...
    @Throws(Exception::class)
    fun getSongsByGenre(genre: String, year: Int, count: Int, offset: Int): MusicDirectory
    ...
    @Throws(Exception::class)
    fun getSongsByMood(mood: String, year: Int, count: Int, offset: Int): MusicDirectory
