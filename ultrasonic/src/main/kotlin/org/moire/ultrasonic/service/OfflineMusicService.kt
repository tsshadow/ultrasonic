...
class OfflineMusicService : MusicService, KoinComponent {
    ...
    */
    ...
    @Throws(Exception::class)
    override fun getSongsByGenre(genre: String, legnth: String?, year: String?, ratingMin: Int, ratingMax: Int,  count: Int, offset: Int): MusicDirectory {
    ...
    @Throws(Exception::class)
    override fun getSongsByMood(mood: String, length: String?, year: String?, ratingMin: Int, ratingMax: Int, count: Int, offset: Int): MusicDirectory {
    ...
    override fun getSongsByYear(year: String, count: Int, offset: Int): MusicDirectory {
        throw OfflineException("Getting Songs By Year tag not available in offline mode")
    }
    ...
    override fun getYears(refresh: Boolean): List<Year>? {
        throw OfflineException("Getting Year tags not available in offline mode")
    }
