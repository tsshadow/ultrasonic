 ...
 * @author Sindre Mehus
 */
public class YearAdapter extends ArrayAdapter<Year> implements SectionIndexer
{
	...
	public YearAdapter(Context context, List<Year> year)
	{
		super(context, R.layout.list_item_generic, year);
		...
		{
			Year yearitem = year.get(i);
			String index = yearitem.getIndex();
