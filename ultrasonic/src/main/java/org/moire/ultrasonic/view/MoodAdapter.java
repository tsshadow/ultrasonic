 ...
 * @author Sindre Mehus
 */
public class MoodAdapter extends ArrayAdapter<Mood> implements SectionIndexer
{
	...
	{
		super(context, R.layout.generic_text_list_item, mood);
		...
		{
			Mood mooditem = mood.get(i);
			String index = mooditem.getIndex();
