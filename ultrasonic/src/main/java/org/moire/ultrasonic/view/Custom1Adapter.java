 ...
 * @author Sindre Mehus
 */
public class Custom1Adapter extends ArrayAdapter<Custom1> implements SectionIndexer
{
	...
	public Custom1Adapter(Context context, List<Custom1> custom1)
	{
		super(context, R.layout.generic_text_list_item, custom1);
		...
		{
			Custom1 custom1item = custom1.get(i);
			String index = custom1item.getIndex();
